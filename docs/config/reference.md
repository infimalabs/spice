...
| `flows` | `{}` | Per-stem phase lists. Approved phases are `plan`, `todo`, `verify`, and `review`; the default public flow is `todo -> review`. Hidden system projects use the private `todo` flow. |
