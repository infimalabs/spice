...
| `spice/agent/lifecycle.py::run_agent_supervisor#wait; spice/agent/lifecycle.py::run_agent_supervisor#join; spice/agent/lifecycle.py::reap_process_when_done.reap#wait`; `spice/agent/wrap.py::run_agent_command#wait` | The supervisor, daemon reaper, and wrapped foreground child waits intentionally match the agent or command lifetime. Stdout and lane-watch cleanup joins are capped at one second; startup-watch cleanup is capped at three seconds. | Lifetime-bound |
