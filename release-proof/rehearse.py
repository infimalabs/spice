...
import inplaceupgrade as _inplace_upgrade  # noqa: E402
from rehearsalcommon import (  # noqa: E402
    RehearsalError,
...
PRIOR_ARTIFACT_DIRECTORY = _inplace_upgrade.PRIOR_ARTIFACT_DIRECTORY
PRIOR_ARTIFACT_MANIFEST = _inplace_upgrade.PRIOR_ARTIFACT_MANIFEST
UPGRADE_AUTHORITY_STATE = _inplace_upgrade.UPGRADE_AUTHORITY_STATE
UPGRADE_EXCLUDED_STATE = _inplace_upgrade.UPGRADE_EXCLUDED_STATE
UPGRADE_EXCLUSION_REASONS = _inplace_upgrade.UPGRADE_EXCLUSION_REASONS
UPGRADE_GOVERNED_STATE = _inplace_upgrade.UPGRADE_GOVERNED_STATE
UPGRADE_PROJECTION_STATE = _inplace_upgrade.UPGRADE_PROJECTION_STATE
...
_carried_predecessor = _inplace_upgrade._carried_predecessor
_finalize_in_place_upgrade = _inplace_upgrade._finalize_in_place_upgrade
_resolve_predecessor = _inplace_upgrade._resolve_predecessor
_run_installed_probe = _inplace_upgrade._run_installed_probe
_seed_predecessor_install = _inplace_upgrade._seed_predecessor_install
_UpgradeSeed = _inplace_upgrade._UpgradeSeed
_core_upgrade_installed_package = _inplace_upgrade._upgrade_installed_package
_validated_installed_paths = _inplace_upgrade._validated_installed_paths
...
def _assert_state_inventory_is_declared(root: Path) -> list[str]:
    return _core_assert_state_inventory_is_declared(
        root,
        rehearsal_by_store=UPGRADE_REHEARSAL_BY_STORE,
        governed_state=UPGRADE_GOVERNED_STATE,
        excluded_state=UPGRADE_EXCLUDED_STATE,
    )
...
def _upgrade_installed_package(
    ...
    return _core_upgrade_installed_package(
        root,
        wheel,
        scratch,
        seed,
...
def _validate_in_place_upgrade(
    ...
    predecessor = _resolve_predecessor(root, scratch)
