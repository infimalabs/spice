...
TOML_STATIC_EXPORT_PATHS = {
    ...
    "spice.agent.claudeautocompact.CLAUDE_AUTO_COMPACT_WINDOW_TOKENS": "agent.claude.auto_compact_window_tokens",
    "spice.agent.codexautocompact.CODEX_AUTO_COMPACT_WINDOW_TOKENS": "agent.codex.auto_compact_window_tokens",
