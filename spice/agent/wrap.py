...
from spice.paths import STATE_DIRNAME, worktree_spice_source
...
def build_agent_run_environment(
    ...
    *,
    ...
    env = None
    if is_spice_route(args) or (
        shell_execution_command_index(args) is not None
        and worktree_spice_source(repo_root) is not None
    ):
