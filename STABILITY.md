...
| Public library seam | Stable | Modules documented in the README library seam are intended for repo tools, including `spice.errors`, `spice.policy`, `spice.flexstate`, `spice.locking`, `spice.paths`, `spice.procs`, `spice.repocfg`, and named study helpers. Underscored names remain private. |
